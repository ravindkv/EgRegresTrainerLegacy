void Plot_mean(){
    ...
    // TFile *f = new TFile("/eos/home-a/arun/EGMRegression_rootFiles/inputrootfiles/results/Run3HLT_IdealIC_IdealTraining_stdVar_stdCuts_ntrees1500_applied.root");
    TFile *f = new TFile("Run3HLT_IdealIC_IdealTraining_stdVar_stdCuts_ntrees1500_applied.root");
    TTree *T  = (TTree*)f->Get("egHLTRun3Tree");
    // TTree *T  = (TTree*)f->Get("egHLTRun3TreeFriend");
    // T->AddFriend("egHLTRun3TreeFriend","/eos/home-a/arun/EGMRegression_rootFiles/inputrootfiles/results/Run3HLT_IdealIC_IdealTraining_stdVar_stdCuts_ntrees1500_applied.root");

    TCanvas* c1 = new TCanvas();
    // c1->SetLogy(1);
    // TLegend* l1 = new TLegend(0.60,0.70, 0.96,0.90);
    TLegend* l1 = new TLegend(0.15,0.70, 0.46,0.90);
    TH1F* h1 = new TH1F("h1","",144, 0.2, 2.0);
    TH1F* h2 = new TH1F("h2","",144, 0.2, 2.0);
    h1->SetLineWidth(2);
    h2->SetLineWidth(2);
    h1->SetLineColor(1);
    h2->SetLineColor(2);
