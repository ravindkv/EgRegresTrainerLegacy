...
// Thu Nov 25 13:40:08 2021 by ROOT version 6.24/06
// from TTree egHLTRun3Tree/
// found on file: Run3HLT_RealIC_IdealTraining_stdVar_stdCuts_ntrees1500_applied.root
//////////////////////////////////////////////////////////

#ifndef egHLTRun3Tree_old_h
#define egHLTRun3Tree_old_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //L1Analysis::L1AnalysisL1UpgradeDataFormat *L1Upgrade;
   ...
   vector<float>   sumBx;
   UInt_t          nrEgs;
   Float_t         eg_et[9];   //[nrEgs]
   Float_t         eg_energy[9];   //[nrEgs]
   Float_t         eg_rawEnergy[9];   //[nrEgs]
   Float_t         eg_eta[9];   //[nrEgs]
   Float_t         eg_phi[9];   //[nrEgs]
   Float_t         eg_phiWidth[9];   //[nrEgs]
   Int_t           eg_nrClus[9];   //[nrEgs]
   UInt_t          eg_seedId[9];   //[nrEgs]
   Int_t           eg_seedDet[9];   //[nrEgs]
   Float_t         eg_sigmaIEtaIEta[9];   //[nrEgs]
   Float_t         eg_sigmaIPhiIPhi[9];   //[nrEgs]
   Float_t         eg_sigmaIEtaIEtaNoise[9];   //[nrEgs]
   Float_t         eg_sigmaIPhiIPhiNoise[9];   //[nrEgs]
   Float_t         eg_ecalPFIsol[9];   //[nrEgs]
   Float_t         eg_hcalPFIsol[9];   //[nrEgs]
   Float_t         eg_trkIsol[9];   //[nrEgs]
   Float_t         eg_trkChi2[9];   //[nrEgs]
   Float_t         eg_trkMissHits[9];   //[nrEgs]
   Float_t         eg_trkValidHits[9];   //[nrEgs]
   Float_t         eg_invESeedInvP[9];   //[nrEgs]
   Float_t         eg_invEInvP[9];   //[nrEgs]
   Float_t         eg_trkDEta[9];   //[nrEgs]
   Float_t         eg_trkDEtaSeed[9];   //[nrEgs]
   Float_t         eg_trkDPhi[9];   //[nrEgs]
   Float_t         eg_trkNrLayerIT[9];   //[nrEgs]
   Float_t         eg_pms2[9];   //[nrEgs]
   Float_t         eg_hcalHForHoverE[9];   //[nrEgs]
   Float_t         eg_bestTrkChi2[9];   //[nrEgs]
   Float_t         eg_bestTrkDEta[9];   //[nrEgs]
   Float_t         eg_bestTrkDEtaSeed[9];   //[nrEgs]
   Float_t         eg_bestTrkDPhi[9];   //[nrEgs]
   Float_t         eg_bestTrkMissHits[9];   //[nrEgs]
   Float_t         eg_bestTrkNrLayerIT[9];   //[nrEgs]
   Float_t         eg_bestTrkESeedInvP[9];   //[nrEgs]
   Float_t         eg_bestTrkInvEInvP[9];   //[nrEgs]
   Float_t         eg_bestTrkValitHits[9];   //[nrEgs]
   Float_t         eg_clusterMaxDR[9];   //[nrEgs]
   Float_t         eg_r9Frac[9];   //[nrEgs]
   Float_t         eg_r9Full[9];   //[nrEgs]
   UChar_t         eg_isEB[9];   //[nrEgs]
   UChar_t         eg_isEE[9];   //[nrEgs]
   Float_t         eg_gen_energy[9];   //[nrEgs]
   Float_t         eg_gen_pt[9];   //[nrEgs]
   Float_t         eg_gen_et[9];   //[nrEgs]
   Float_t         eg_gen_eta[9];   //[nrEgs]
   Float_t         eg_gen_phi[9];   //[nrEgs]
   Float_t         eg_gen_vz[9];   //[nrEgs]
   Float_t         eg_l1eg_et[9];   //[nrEgs]
   Float_t         eg_l1eg_eta[9];   //[nrEgs]
   Float_t         eg_l1eg_phi[9];   //[nrEgs]
   Float_t         eg_l1eg_hwEt[9];   //[nrEgs]
   Float_t         eg_l1eg_hwEta[9];   //[nrEgs]
   Float_t         eg_l1eg_hwPhi[9];   //[nrEgs]
   Float_t         eg_l1eg_hwQual[9];   //[nrEgs]
   Float_t         eg_l1eg_iso[9];   //[nrEgs]
   Float_t         eg_l1eg_isoEt[9];   //[nrEgs]
   Float_t         eg_l1eg_nTT[9];   //[nrEgs]
   Float_t         eg_l1eg_footprintEt[9];   //[nrEgs]
   Float_t         eg_l1eg_shape[9];   //[nrEgs]
   Float_t         eg_l1eg_towerHoE[9];   //[nrEgs]
   ...
   Float_t         regIdealMean;
   Float_t         regIdealSigma;
   Float_t         regIdealInvTar;
   ...
   TBranch        *b_regIdealSigma;   //!
   TBranch        *b_regIdealInvTar;   //!

   egHLTRun3Tree_old(TTree *tree=0);
   virtual ~egHLTRun3Tree_old();
...
#ifdef egHLTRun3Tree_old_cxx
egHLTRun3Tree_old::egHLTRun3Tree_old(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Run3HLT_RealIC_IdealTraining_stdVar_stdCuts_ntrees1500_applied.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Run3HLT_RealIC_IdealTraining_stdVar_stdCuts_ntrees1500_applied.root");
      }
...
egHLTRun3Tree_old::~egHLTRun3Tree_old()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t egHLTRun3Tree_old::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t egHLTRun3Tree_old::LoadTree(Long64_t entry)
{
...
void egHLTRun3Tree_old::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("regIdealMean", &regIdealMean, &b_regIdealMean);
   fChain->SetBranchAddress("regIdealSigma", &regIdealSigma, &b_regIdealSigma);
   fChain->SetBranchAddress("regIdealInvTar", &regIdealInvTar, &b_regIdealInvTar);
   Notify();
}

Bool_t egHLTRun3Tree_old::Notify()
{
...
void egHLTRun3Tree_old::Show(Long64_t entry)
{
...
Int_t egHLTRun3Tree_old::Cut(Long64_t entry)
{
...
#endif // #ifdef egHLTRun3Tree_old_cxx
