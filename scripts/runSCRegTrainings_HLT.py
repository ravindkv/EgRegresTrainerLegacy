...
def main():
    ...
    # parser.add_argument('--input_dir','-i',default='/afs/cern.ch/work/a/arun/EGMHLT/Regression/CMSSW_12_0_0_pre4/src',help='input directory with the ntuples')
    ...
    cuts_name = "stdCuts"
    #base_ele_cuts = "(eg_gen_energy>0 && ssFrac.sigmaIEtaIEta>0 && ssFrac.sigmaIPhiIPhi>0 && {extra_cuts})"
    ...
    print("DEBUG_RAM:: Cuts_base: {}".format(base_ele_cuts.format(extra_cuts = ideal_eventnr_cut)))
...
steps to be run:
    ...
    print("DEBUG_RAM:: Cuts_base: {}".format(base_ele_cuts.format(extra_cuts = real_eventnr_cut)))
