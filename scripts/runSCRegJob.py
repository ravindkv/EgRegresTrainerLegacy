...
def run_eb_and_ee(regArgs):  
    ...
    subprocess.Popen(["bin/$SCRAM_ARCH/RegressionApplierExe",regArgs.input_testing,regArgs.applied_name(),"--gbrForestFileEE",forest_ee_file,"--gbrForestFileEB",forest_eb_file,"--nrThreads","4"]).communicate()
