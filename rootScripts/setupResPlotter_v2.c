 {
	...
	// std::vector<double> etaBins3p0 = {-1.4442,1.4442};
	...
	// inFile = "/eos/user/r/rasharma/post_doc_ihep/EGamma/HLT/regression/ReRunHLT_WithDB/pfscecal_EBCorrection_online_Run3_120X_v1_Flat.root";
	// inFile = "/eos/user/r/rasharma/post_doc_ihep/EGamma/HLT/regression/ReRunHLT_WithDB/pfscecal_EBCorrection_online_Run3_120X_v1.root";
    ...
    std::vector<std::string> plotVars = {"eg_rawEnergy/eg_gen_energy:eg_gen_eta","eg_energy/eg_gen_energy:eg_gen_eta","regInvTar*regMean:eg_gen_eta"};
    // std::vector<std::string> plotVars = {"eg_rawEnergy/eg_gen_energy:eg_gen_eta","eg_energy/eg_gen_energy:eg_gen_eta"};
	...
	// std::cout << resStudies::etStr << std::endl;
	...
	compareRes({hists3[0],"Raw Energy"},{hists3[1],"Corr energy (OLD)"},{hists3[2],"Corr energy (NEW)"}, 6);
