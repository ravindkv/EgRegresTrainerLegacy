...
// Thu Nov 25 13:03:11 2021 by ROOT version 6.24/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //L1Analysis::L1AnalysisL1UpgradeDataFormat *L1Upgrade;
   ...
   Float_t         regRealMean;
   Float_t         regRealSigma;
   Float_t         regRealInvTar;
   ...
   TBranch        *b_regRealMean;   //!
   TBranch        *b_regRealSigma;   //!
   TBranch        *b_regRealInvTar;   //!

   egHLTRun3Tree(TTree *tree=0);
...
#ifdef egHLTRun3Tree_cxx
egHLTRun3Tree::egHLTRun3Tree(TTree *tree) : fChain(0) 
{
...
void egHLTRun3Tree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("regRealMean", &regRealMean, &b_regRealMean);
   fChain->SetBranchAddress("regRealSigma", &regRealSigma, &b_regRealSigma);
   fChain->SetBranchAddress("regRealInvTar", &regRealInvTar, &b_regRealInvTar);
   Notify();
}

Bool_t egHLTRun3Tree::Notify()
{
...
void egHLTRun3Tree::Show(Long64_t entry)
{
...
Int_t egHLTRun3Tree::Cut(Long64_t entry)
{
