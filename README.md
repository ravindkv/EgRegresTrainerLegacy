...
The trainer is ntuple agnoistic and can run on any reasonable input.
...
- regression input variables (EB) : a list of variables separated by ":" to take as input for the barrel
- regression input variables (EE) : a list of variables separated by ":" to take as input for the endcap
...
compareRes({hists[0],"ECAL Energy"},{hists[1],"existing energy"},6, "0", "20");
# compareRes({hists[0],"ECAL Energy"},{hists[1],"existing energy"},6, "20", "60");

hists = makeHists(regTestTree,{-3.0,-2.5,-2.,-1.6,-1.566,-1.4442,-1.1,-0.7,0.,0.7,1.1,1.4442,1.566,1.6,2.,2.5,3.0},150,0,1.5,{"invTar*mean:eg_gen_eta","eg_energy/eg_gen_energy:eg_gen_eta"},"eg_energy>0 && eg_sigmaIEtaIEta>0 && eg_gen_pt>100 && eg_gen_pt<500 && (mean<1.045 || mean>1.050)");

hists = makeHists(regTestTree,{-2.5,-2.,-1.6,-1.566,-1.4442,-1.1,-0.7,0.,0.7,1.1,1.4442,1.566,1.6,2.,2.5},150,0,1.5,{"invTar*mean:eg_gen_eta","eg_energy/eg_gen_energy:eg_gen_eta"},"eg_energy>0 && eg_sigmaIEtaIEta>0 && eg_gen_pt>100 && eg_gen_pt<500");
compareRes({hists[0],"ECAL Energy"},{hists[1],"existing energy"},6, "100", "500_Eta_2p5");
