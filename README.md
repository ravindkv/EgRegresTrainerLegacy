...
It is [https://github.com/cms-egamma/RegressionTrainer](https://github.com/cms-egamma/RegressionTrainer) and [https://github.com/cms-egamma/HiggsAnalysis](https://github.com/cms-egamma/HiggsAnalysis) ported to a common build system. It links against CMSSW but is otherwise standalone and is not built as part of CMSSW.
